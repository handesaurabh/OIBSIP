...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const animateElements = document.querySelectorAll('.feature-card, .contact-item, .footer-section, .testimonial-card, .skill-item, .stat-number');
...
function initRevealAnimations() {
    const revealElements = document.querySelectorAll('.section-title, .section-subtitle, .about-description');
...
const revealStyles = `
    ...
    .section-title.revealed, .section-subtitle.revealed, .about-description.revealed {
        opacity: 1;
